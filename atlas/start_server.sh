...
./ShooterGameServer "Ocean?ServerX=0?ServerY=0?MaxPlayers=10?Port=5701?QueryPort=57501?SeamlessIP=159.203.52.169?ServerAdminPassword=changeme?RCONEnabled=True?RCONPort=27020?ReservedPlayerSlots=0 -log -server -ForceAllHomeServer -NoSeamlessServer"
