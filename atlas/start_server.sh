...
./ShooterGameServer "Ocean?ServerX=0?ServerY=0?MaxPlayers=10?Port=27018?QueryPort=27019?SeamlessIP=159.203.52.169?ServerAdminPassword=changeme?RCONEnabled=True?RCONPort=27020?ReservedPlayerSlots=0 -log -server -ForceAllHomeServer -NoSeamlessServer"
